...
require_once( plugin_dir_path( __FILE__ ) . 'includes/class-grid-accordion-validation.php' );
...
if ( is_admin() ) {
	...
	require_once( plugin_dir_path( __FILE__ ) . 'admin/class-grid-accordion-add-ons.php' );
